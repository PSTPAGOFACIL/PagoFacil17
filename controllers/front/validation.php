...
class Pagofacil17ValidationModuleFrontController extends ModuleFrontController
{
    /**
    ...
    public function postProcess()
    {
        ...
        $s_key = Context::getContext()->customer->secure_key;
        ...
        $c_id = (int)Context::getContext()->currency->id;

        return $this->module->validateOrder($cart_id, $status, $amount, $name, $message, array(), $c_id, false, $s_key);
    }
